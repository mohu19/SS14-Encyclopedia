...
> 条目ID: `CoreRuleset` ｜ 来源层: official ｜ 分类: rules
...
﻿
  ...
  <span style="color:#ff0000">Only the Core Rules apply on this server.</span> This is NOT a medium roleplay (MRP) server, meaning that MRP Amendments do NOT apply.
