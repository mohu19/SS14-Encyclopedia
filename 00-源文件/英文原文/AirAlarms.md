...
> 条目ID: `AirAlarms` ｜ 来源层: official ｜ 分类: engineering
...
﻿
  ...
  - <span style="color:green">Normal</span>: The area is safe to breathe in.
  - <span style="color:yellow">Warning</span>: The area is starting to deviate from the desired atmosphere, and is becoming unsafe.
  - <span style="color:red">Danger</span>: The area is no longer safe, internals and/or hardsuits are required.
  ...
  These [textlink="firelocks" link="FireAndGasControl"] will automatically raise (open) when the status returns to <span style="color:green">Normal</span>.
  ...
  These sensors can be adjusted in the **Sensors** tab of the air alarm menu.
  ...
  - Fill: [textlink="Air Vents" link="AirVent"] will be enabled with their external bound set to max pressure, <span style="color:orange">[protodata="GasVentPump" comp="GasVentPump" member="MaxPressure"/] kPa</span>. [textlink="Air Scrubbers" link="AirScrubber"] will be disabled.
  ...
  - If the area reaches <span style="color:red">Danger</span> status or above, the air alarm will switch to Filtering (Wide) mode.
  - If the area reaches <span style="color:green">Normal</span> or <span style="color:yellow">Warning</span> status, the air alarm will switch to Filtering mode.
