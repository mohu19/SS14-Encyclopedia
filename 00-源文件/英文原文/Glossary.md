...
> 条目ID: `Glossary` ｜ 来源层: official ｜ 分类: station
...
Abbreviation for All Access, or an ID which has every access on the station. The captain is the only person who will have this kind of access under normal circumstances.
...
Abbreviation for Chief Engineer, the head of the Engineering Department.
...
## CL
Abbreviation for Corporate Law. The legal code in force on the station.


## CMO

Abbreviation for Chief Medical Officer, the head of the Medical Department.
...
Abbreviation for Emergency Response Team. These may be dispatched by Central Command for a number of purposes.
...
Typically utilized to refer to an Assistant due to the color of their standard uniform in other sectors, though this may be used to negatively refer to other crew members (not only assistants) who act unruly or commit various minor crimes.

## HoP

Abbreviation for Head of Personnel, head of the Service Department. Can also refer to the HoP's office, where IDs are given or changed.

## HoS

Abbreviation for Head of Security, head of the Security Department.
...
Abbreviation for Kill On Sight. Someone has commited such a serious crime that they are deemed not even worth arresting.

## Mats

Short for Materials. Usually steel, plastic, plasteel, glass, silver and gold.
...
Abbreviation for Quartermaster, the head of the Cargo department.

## RD

Abbreviation for Research Director, the head of the Science Department.
...
## SOP
Abbreviation for Standard Operating Procedures. The policies and guidelines everyone on the station is expected to follow.
...
Abbreviation for Sudden Sleep Disorder or Space Sleep Disorder. This is an in-character way to refer to a player who has disconnected and is no longer responding.
...
Abbreviation for Telecrystal, a currency used by Syndicate Agents to purchase restricted contraband such as weapons and other illegal equipment.
...
Abbreviations for local out-of-character and (global) out-of-character respectively. They are text channels that allow players to talk to other players outside of roleplay. LOOC is enabled during rounds, while OOC is typically only on after the round ends.

## LRP

Abbreviation for Low Roleplay. Servers marked LRP typically have relaxed roleplaying rules.

## MRP

Abbreviation for Medium Roleplay. Servers marked MRP usually have a decent basis of roleplaying rules and generally require players to act as their character would realistically in a given situation. Less leeway is afforded to behavior such as openly defying Security or your boss.

## HRP

Abbreviation for High Roleplay. Servers marked HRP generally have extensive rules on what is and is not constituted while playing a character. You are generally required to act as your character would, have a character backstory, and follow protocol on the station. Some HRP servers may create their own lore or settings to further facilitate the type of server they wish to host.
