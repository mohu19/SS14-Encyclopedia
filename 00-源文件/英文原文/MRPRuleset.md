...
> 条目ID: `MRPRuleset` ｜ 来源层: official ｜ 分类: rules
...
# Server Rules
  ...
  This is a roleplay server, meaning that roleplay rules apply. <span style="color:#ff0000">This is also a medium roleplay (MRP) server, meaning that MRP Amendments do apply.</span>
  ...
  ## Roleplay Rules
  These rules only apply during a round. A round ends only when the game returns to the lobby. <span style="color:#ff0000">All of these rules apply fully whenever the game is not at the lobby unless it is in an exempt game mode.</span>
  ...
  - [textlink="4. Do not metagame, do not metagrudge" link="RuleR4"]
