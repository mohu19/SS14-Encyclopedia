...
> 条目ID: `RuleSL11` ｜ 来源层: starlight ｜ 分类: rules
...
# Rule 11 - New Life.
 The New Life system allows players to rejoin the round as a new character after death.
 However, this feature comes with roleplay restrictions to maintain fairness and immersion.
...
Additionally, Ghosting and the New Life system may not be used to avoid in-character punishment such as jail sentences or relief from duty.
- **Leaving To Avoid Punishment (LTAP)** – Ghosting after you've been caught by security and using new life is not allowed.
Exceptions will be made for perma prisoners, who may utilize the system within reason.
If a player must leave due to real-life reasons under these conditions, they should make an LOOC message to inform the players around them, or state it in Ahelp.
