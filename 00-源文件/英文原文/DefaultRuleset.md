...
> 条目ID: `DefaultRuleset` ｜ 来源层: official ｜ 分类: rules
...
Players are also expected to understand Metashield. All rules and the metashield are often more up to date on the starlight wiki.
