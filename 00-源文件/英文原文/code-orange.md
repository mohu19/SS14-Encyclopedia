...
> 条目ID: `code-orange` ｜ 来源层: starlight ｜ 分类: sop
...
﻿
    ...
    4. Direct crew to the evacuation shuttle upon its arrival.


    ## Secure Areas:


    1. Secure areas except for the Armory, Gravity Generator, and Vault should be given emergency access.
    ...
    2. If feasible, work with your department to first end the ongoing disaster, then repair the station.
