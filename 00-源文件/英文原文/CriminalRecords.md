...
> 条目ID: `CriminalRecords` ｜ 来源层: official ｜ 分类: security
...
﻿
  ...
  In the record section you can:
    ...
    - Change the security status between <span style="color:gray">None</span>, <span style="color:yellow">Wanted</span> and <span style="color:red">Detained</span>. When setting it to Wanted you will be asked to write a reason.
